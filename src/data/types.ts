...
export type Word = { id:number; level:Level; arabic:string; transliteration:string; turkish_meaning:string; root:string|null; part_of_speech:string; memory_hint:string; example_arabic:string; example_turkish:string; grammar_note:string; };
